...
import {setCurrent,setCode,setWritting,setFcode,setRenameFlag} from '../../redux/actions'
...
class File extends React.Component {
	...
	render() {
		...
		return (
			<>
			<div className={(current.path===this.props.info.path) ?"active" :""}style={{ cursor: 'pointer', width: "100%", whiteSpace: "nowrap"}}
