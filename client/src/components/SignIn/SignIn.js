      ...
      {sign ? ( 
        <div className="contact-content">
         ...
         <form className="contact100-form validate-form" onSubmit={SignInHandler}>
              ...
              <p className="form_footer">You don't have an account <span onClick={toggleSign}>Sing Up</span></p>
              </>)}
          </form>
          </div>
          ...
          <form className="contact100-form validate-form"  onSubmit={SignUpHandler}>
              ...
              <p className="form_footer">Already have an account <span onClick={toggleSign}>Sing In</span></p>
          </form>
          </div>)}
