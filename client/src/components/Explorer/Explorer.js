  ...
  const downloadFile = () => {
   ...
   return (
     ...
     < div className="file-exp">
       <p className="title">Files Exlporer</p>
      <input
        style={{ display: "none" }}
        ref={inputFile}
        type="file"
        onChange={showFile}
      />
      <img className="icons" src={Upload}  alt="a" onClick={onButtonClick} />
      <img className="icons" src={Download}  alt="b" onClick={downloadFile} />
      <img className="icons" src={CreateFol} alt="c" onClick={()=>{setCreatefolder(true);toggleModal();}}/>
      <img className="icons" src={Create} alt="d" onClick={()=>{setCreatefolder(false);toggleModal();}}/>
